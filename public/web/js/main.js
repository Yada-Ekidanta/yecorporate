...
$(function() {
  ...
  if ($("div").is("#map")) {
    ...
    var map = new mapboxgl.Map({
      ...
      center: [107.63859376896585,-6.973838171553325],
      zoom: 14
    });
    map.on('click', function (e) {
        new mapboxgl.Popup()
        .setLngLat([107.63859376896585,-6.973838171553325])
        .setHTML('<h4>Hi, We are <span>Yada Ekidanta</span></h4><p style="margin-top:">Enterprise Digital Transformation Consultant & Integrator Company In Indonesia.</p>')
        .addTo(map);
    });
