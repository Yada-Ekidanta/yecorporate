/**
 * Copyright 2023 Yada Ekidanta
 * Theme core scripts
 *
 * @author Yada Ekidanta
 * @version 1.4.0
 */
let path = window.location.pathname;
const options = {
    containers: ['#main_layout'],
    animateHistoryBrowsing: true,
    linkSelector: '.header a:not([data-no-swup]), .footer a:not([data-no-swup]), .custom-link:not([data-no-swup])',
    animationSelector: '[class="page-wrapper"]'
};
console.log(path);
    ...
    !(function () {
        ...
        null !== (e = document.querySelector('[data-bs-toggle="mode"]')) &&
            ...
            (function (e, t, r) {
                ...
                var r;
                (r = null != t.dataset.swiperOptions ? JSON.parse(t.dataset.swiperOptions) : r).pager &&
                    (a = {
                        pagination: {
                    ...
                    for (
                        var e = function () {
                                var t = v[y],
                                    ...
                                    s = null;
                                e.addEventListener("click", function (e) {
                                    i = "play" === i ? (e.currentTarget.classList.add("ap-pause"), r.play(), requestAnimationFrame(m), "pause") : (e.currentTarget.classList.remove("ap-pause"), r.pause(), cancelAnimationFrame(s), "play");
                                });
                                function c(e) {
                                ...
                                var m = function e() {
                                    (a.value = Math.floor(r.currentTime)), (l.textContent = u(a.value)), t.style.setProperty("--seek-before-width", "".concat((a.value / a.max) * 100, "%")), (s = requestAnimationFrame(e));
                                };
                                0 < r.readyState
                                    ? (d(), p(), f())
