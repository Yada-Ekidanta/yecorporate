    ...
    <div class="menu-sub menu-sub-accordion">
        ...
        <div class="menu-item">
            ...
            <a class="menu-link" href="{{route('office.hrm.master.allowance.index')}}">
                ...
                <span class="menu-title">Allowance Option</span>
            </a>
            <!--end:Menu link-->
        </div>
        <!--end:Menu item-->
        ...
        <div class="menu-item">
            ...
            <a class="menu-link" href="{{route('office.hrm.master.loan-option.index')}}">
                ...
                <span class="menu-title">Loan Option</span>
            </a>
            <!--end:Menu link-->
        </div>
        <!--end:Menu item-->
        ...
        <div class="menu-item">
            ...
            <a class="menu-link" href="{{route('office.hrm.master.deduction-option.index')}}">
                ...
                <span class="menu-title">Deduction Option</span>
            </a>
            <!--end:Menu link-->
        </div>
        <!--end:Menu item-->
        ...
        <div class="menu-item">
            ...
            <a class="menu-link" href="{{route('office.hrm.master.goal-type.index')}}">
                ...
                <span class="menu-title">Goal Type</span>
            </a>
            <!--end:Menu link-->
        </div>
        <!--end:Menu item-->
        ...
        <div class="menu-item">
            ...
            <a class="menu-link" href="{{route('office.hrm.master.training-type.index')}}">
                ...
                <span class="menu-title">Training Type</span>
            </a>
            <!--end:Menu link-->
        </div>
        <!--end:Menu item-->
        ...
        <div class="menu-item">
            ...
            <a class="menu-link" href="{{route('office.hrm.master.award-type.index')}}">
                ...
                <span class="menu-title">Award Type</span>
            </a>
            <!--end:Menu link-->
        </div>
        <!--end:Menu item-->
        ...
        <div class="menu-item">
            ...
            <a class="menu-link" href="{{route('office.hrm.master.termination-type.index')}}">
                ...
                <span class="menu-title">Termination Type</span>
            </a>
            <!--end:Menu link-->
        </div>
        <!--end:Menu item-->
        ...
        <div class="menu-item">
            ...
            <a class="menu-link" href="{{route('office.hrm.master.job-stage.index')}}">
                ...
                <span class="menu-title">Job Stage</span>
            </a>
            <!--end:Menu link-->
        </div>
        <!--end:Menu item-->
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion" data-no-swup>
    ...
    <div class="menu-sub menu-sub-accordion">
        ...
        <div class="menu-item">
            <!--begin:Menu link-->
            <a class="menu-link" href="{{route('office.hrm.timesheet.timesheet.index')}}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
                <span class="menu-title">Timesheet</span>
...
<div data-kt-menu-trigger="click" class="menu-item menu-accordion" data-no-swup>
    ...
    <div class="menu-sub menu-sub-accordion">
        ...
        <div class="menu-item">
            <!--begin:Menu link-->
            <a class="menu-link" href="{{route('office.hrm.training.training_list.index')}}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
...
{{-- <div data-kt-menu-trigger="click" class="menu-item menu-accordion" data-no-swup>
    ...
    <div class="menu-sub menu-sub-accordion">
        ...
        <div class="menu-item">
            <!--begin:Menu link-->
            <a class="menu-link" href="{{route('office.hrm.recruitment.job-list.index')}}">
                <span class="menu-bullet">
                    <span class="bullet bullet-dot"></span>
                </span>
...
<div class="menu-item">
    <!--begin:Menu link-->
    <a class="menu-link" href="{{ route('office.hrm.contract.index') }}">
        <span class="menu-icon">
