        ...
        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
                                ...
                                <div class="menu-active-bg px-4 px-lg-0">
                                    ...
                                    <div class="tab-content py-4 py-lg-8 px-lg-7">
                                        ...
                                        <div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-4">
                                                <img src="#" class="rounded mw-100" alt="" />
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                        <!--end:Tab pane-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-3">
                    <!--begin::Menu toggle-->
                    <a href="#" class="btn btn-icon btn-custom btn-icon-muted btn-active-light btn-active-color-primary w-30px h-30px w-md-40px h-md-40px" data-kt-menu-trigger="{default:'click', lg: 'click'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
