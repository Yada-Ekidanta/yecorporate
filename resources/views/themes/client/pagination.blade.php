<ul class="pagination pagination-circle pagination-outline">
    ...
    @else
    <li class="page-item previous m-1"><a href="javascript:;" data-halaman="{{ $paginator->previousPageUrl() }}" class="page-link"><i class="previous"></i></a></li>
    @endif
    ...
    <li class="page-item next m-1"><a href="javascript:;" data-halaman="{{ $paginator->nextPageUrl() }}" class="page-link"><i class="next"></i></a></li>
    @else
