<x-office-layout title="{{ $data->id ? 'Update' : 'Create' }} Call">
    <!--begin::Toolbar-->
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <li class="breadcrumb-item text-muted">Call</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-3 py-lg-6 animation-class delay3">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card">
                <form class="form w-100" novalidate="" id="form_input" data-redirect-url="{{ route('office.crm.call.index') }}"
                    action="{{ $data->id ? route('office.crm.call.update', $data->id) : route('office.crm.call.store') }}">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                <h1>Form {{ $data->id ? 'Update' : 'Create' }} Call</h1>
                            </div>
                        </div>
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a id="back_form_button" href="{{ route('office.crm.call.index') }}" class="btn btn-primary btn-sm btn-hover-scale menu-link">
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    <select name="direction" id="direction" class="form-select">
                                        ...
                                        <option value="0" {{ $data->direction === 0 ? 'selected' : '' }}>Outbound</option>
                                        <option value="1" {{ $data->direction === 1 ? 'selected' : '' }}>Inbound</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                    ...
                    <div class="card-footer">
                        ...
                        @if ($data->id)
                            <button type="button" onclick="handle_confirm('Are you sure want to delete this Opportunity ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{ route('office.crm.call.destroy', $data->id) }}');"
