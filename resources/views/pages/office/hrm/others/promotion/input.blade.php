<x-office-layout title="{{$data->id ? 'Update' : 'Create'}} Promotion">
    <!--begin::Toolbar-->
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-3 py-lg-6 animation-class delay3">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card">
                <form class="form w-100" novalidate="novalidate" id="form_input" data-redirect-url="{{route('office.hrm.others.promotion.index')}}" action="{{$data->id ? route('office.hrm.others.promotion.update',$data->id) : route('office.hrm.others.promotion.store')}}">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                <h1>Form {{$data->id ? 'Update' : 'Create'}} Promotion</h1>
                            </div>
                        </div>
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a id="back_form_button" href="{{route('office.hrm.others.promotion.index')}}" class="btn btn-primary btn-sm btn-hover-scale menu-link">
                    ...
                    <div class="card-body transition-fade">
                        <div class="form-group row">
                            ...
                            <div class="col-6 mb-3">
                                <div class="form-floating">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="promotion_title" name="promotion_title" placeholder="Indonesia" value="{{$data->promotion_title}}"/>
                            ...
                            <div class="col-6 mb-3">
                                <div class="form-floating">
                                    <div class="form-floating">
                                        <input type="text" class="form-control datestartnow" id="promotion_date" name="promotion_date" placeholder="Indonesia" value="{{$data->promotion_date}}"/>
