<x-office-layout title="{{$data->id ? 'Update' : 'Create'}} Award">
    <!--begin::Toolbar-->
        ...
        <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
            ...
            <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Award</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-400 w-5px h-2px"></span>
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-3 py-lg-6 animation-class delay3">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card">
                <form class="form w-100" novalidate="novalidate" id="form_input" data-redirect-url="{{route('office.hrm.others.award.index')}}" action="{{$data->id ? route('office.hrm.others.award.update',$data->id) : route('office.hrm.others.award.store')}}">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a id="back_form_button" href="{{route('office.hrm.others.award.index')}}" class="btn btn-primary btn-sm btn-hover-scale menu-link">
                        ...
                        <div class="form-group row">
                            <div class="col-6 mb-3">
                                <div class="form-floating">
                                    <select name="employee_id" data-placeholder="Select a employee.." id="employee_id" class="form-select form-select-solid form-select-lg">
                                        <option value=""></option>
                            ...
                            <div class="col-6 mb-3">
                                <div class="form-floating">
                                    <div class="form-floating">
                                        <input type="text" class="form-control" id="gift" name="gift" placeholder="Indonesia" value="{{$data->gift}}"/>
                    ...
                    <div class="card-footer">
                        ...
                        @if($data->id)
                        <button type="button" onclick="handle_confirm_custom('Are you sure want to delete this award ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.hrm.others.award.destroy',$data->id)}}', '{{ route('office.hrm.others.award.index') }}');" class="btn btn-sm btn-danger">
                            Delete
                        </button>
                        @endif
                    </div>
