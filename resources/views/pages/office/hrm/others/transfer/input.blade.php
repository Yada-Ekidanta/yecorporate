<x-office-layout title="{{$data->id ? 'Update' : 'Create'}} Transfer">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-3 py-lg-6 animation-class delay3">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card">
                <form class="form w-100" novalidate="novalidate" id="form_input" data-redirect-url="{{route('office.hrm.others.transfer.index')}}" action="{{$data->id ? route('office.hrm.others.transfer.update',$data->id) : route('office.hrm.others.transfer.store')}}">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a id="back_form_button" href="{{route('office.hrm.others.transfer.index')}}" class="btn btn-primary btn-sm btn-hover-scale menu-link">
                    ...
                    <div class="card-body transition-fade">
                        <div class="form-group row">
                            <div class="col-6 mb-3">
                                <div class="form-floating">
                                    <select name="employee_id" id="employee_id" data-placeholder="Select a company employee..."class="form-select form-select-solid form-select-lg">
                                        <option value=""></option>
                            ...
                            <div class="col-6 mb-3">
                                <div class="form-floating">
                                    <select name="company_branch_id" data-placeholder="Select a company branch..." id="company_branch_id" class="form-select form-select-solid form-select-lg">
                                        <option value=""></option>
                        ...
                        <div class="form-group row">
                            <div class="col-6 mb-3">
                                <div class="form-floating">
                                    <select name="department_id" data-placeholder="Select a company department..." id="department_id" class="form-select form-select-solid form-select-lg">
                                        <option value=""></option>
                        ...
                        <div class="form-group row">
                            <div class="col-6 mb-3">
                                <div class="form-floating">
                                    <div class="form-floating">
                                        <input type="text" class="form-control datestartnow" id="transfer_date" name="transfer_date" placeholder="Indonesia" value="{{$data->transfer_date}}"/>
                    ...
                    <div class="card-footer">
                        ...
                        @if($data->id)
                        <button type="button" onclick="handle_confirm_custom('Are you sure want to delete this transfer ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.hrm.others.transfer.destroy',$data->id)}}', '{{ route('office.hrm.others.transfer.index') }}');" class="btn btn-sm btn-danger">
                            Delete
                        </button>
                        @endif
                    </div>
