<x-office-layout title="{{$data->id ? 'Update' : 'Create'}} Country">
    <!--begin::Toolbar-->
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-3 py-lg-6 animation-class">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card">
                <form class="form w-100" novalidate="novalidate" id="form_input" data-redirect-url="{{route('office.master.regional.index')}}" action="{{$data->id ? route('office.master.regional.update',$data->id) : route('office.master.regional.store')}}">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                <h1>Form {{$data->id ? 'Update' : 'Create'}} Country</h1>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        ...
                        @if($data->id)
                        <button type="button" onclick="handle_confirm('Are you sure want to delete this allowance ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.master.regional.destroy',$data->id)}}');" class="btn btn-sm btn-danger">
                            Delete
                        </button>
                        @endif
                    </div>
