                ...
                <div class="col-8">
                    <div class="card shadow-sm">
                        ...
                        <div id="kt_docs_card_collapsible" class="collapse show">
                            <form class="form w-100" id="form_input" action="{{$data->id ? route('office.master.role.update',$data->id) : route('office.master.role.store')}}" data-redirect-url="{{route('office.master.department.show',$position->department_id)}}">
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    ...
                                    @if($data->id)
                                    <button type="button" onclick="handle_confirm('Are you sure want to delete this position ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.master.position.destroy',$data->id)}}');" class="btn btn-sm btn-danger">
                                        Delete
                                    </button>
                                    @endif
                                </div>
