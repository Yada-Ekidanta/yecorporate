            ...
            <div class="card">
                <form class="form w-100" novalidate="novalidate" id="form_input" data-redirect-url="{{route('office.finance.journal.index')}}" action="{{$data->id ? route('office.finance.journal.update',$data->id) : route('office.finance.journal.store')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="rates" name="rates" value=""/>
                                </div>
                            </div>
                            <div class="col-4 mb-3">
                                <div class="form-group">
                                    <label class="form-label text-gray-700 fw-bold" for="costumer_id">Transaction Date</label>
                            ...
                            <div class="col-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="textarea" class="form-control" id="reference" name="reference" value="{{$data->reference}}"/>
                                </div>
                            </div>
                            <div class="col-6 mb-3">
                                <div class="form-group">
                                    <label class="form-label text-gray-700 fw-bold" for="description">Description</label>
                                    <textarea type="textarea" class="form-control" id="description" name="description" value="{{$data->description}}"/></textarea>
                                </div>
                            </div>
                    ...
                    <div class="card-footer">
                        ...
                        @if($data->id)
                        <button type="button" onclick="handle_confirm('Are you sure want to delete this Proposal ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.finance.journal.destroy',$data->id)}}');" class="btn btn-sm btn-danger">
                            Delete
                        </button>
                        @endif
                    </div>
