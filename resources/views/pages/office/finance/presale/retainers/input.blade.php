                        ...
                        <div class="card">
                            ...
                            <div class="card-body transition-fade">
                                ...
                                <div class="form-group">
                                    <label class="form-label text-gray-700 fw-bold" for="retainers_number">Retainers Number</label>
                                    <input type="text" class="form-control" id="retainers_number" name="retainers_number" placeholder="" value="RETN000{{$retainers_number}}" disabled/>
                                </div>
                                    ...
                                    <div class="card-body transition-fade">
                                        <div class="form-group">
                                            <div data-repeater-list="kt_docs_repeater_basic">
                                                @if ($data->id)
                                                    @foreach ($data->retainerItems as $key => $varian)
