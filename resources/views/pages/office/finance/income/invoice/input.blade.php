            ...
            <div class="card">
                <form class="form w-100" novalidate="novalidate" id="form_input" data-redirect-url="{{route('office.finance.invoice.index')}}" action="{{$data->id ? route('office.finance.invoice.update',$data->id) : route('office.finance.invoice.store')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label text-gray-700 fw-bold" for="costumer_id">Due Date</label>
                                            <input type="date" class="form-control" id="rates" name="rates" placeholder="102" value="{{$data->rates}}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label text-gray-700 fw-bold" for="costumer_id">Invoice Number</label>
                                            <input type="text" class="form-control" id="rates" name="rates" placeholder="#INVO00001" value="{{$data->rates}}" disabled/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="form-label text-gray-700 fw-bold" for="costumer_id">Reff Number</label>
                                            <input type="text" class="form-control" id="rates" name="rates" value="{{$data->rates}}"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="card-footer">
                        ...
                        @if($data->id)
                        <button type="button" onclick="handle_confirm('Are you sure want to delete this Proposal ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.finance.invoice.destroy',$data->id)}}');" class="btn btn-sm btn-danger">
                            Delete
                        </button>
                        @endif
                    </div>
