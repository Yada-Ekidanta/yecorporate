<x-office-layout title="{{$data->id ? 'Update' : 'Create'}} Invoice">
    <!--begin::Toolbar-->
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-3 py-lg-6 animation-class delay3">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <form class="form w-100" novalidate="novalidate" id="form_input" data-redirect-url="{{route('office.finance.invoice.index')}}" action="{{$data->id ? route('office.finance.invoice.update',$data->id) : route('office.finance.invoice.store')}}">
                <div class="card">
                    <div class="card-header border-0 pt-6">
                        <div class="card-title">
                            <div class="d-flex align-items-center position-relative my-1">
                                <h1>Form {{$data->id ? 'Update' : 'Create'}} Invoice</h1>
                            </div>
                        </div>
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a id="back_form_button" href="{{route('office.finance.invoice.index')}}" class="btn btn-primary btn-sm btn-hover-scale menu-link">
                            ...
                            <div class="card-body transition-fade">
                                ...
                                <div class="col-mt-5">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="issue_date" name="issue_date" placeholder="102" value="{{$data->issue_date}}"/>
                                    </div>
                                </div>
                                <div class="col-mt-5">
                                    <div class="form-group">
                                        <label class="form-label text-gray-700 fw-bold" for="due_at">Due Date</label>
                                        <input type="date" class="form-control" id="due_at" name="due_at" placeholder="102" value="{{$data->due_at}}"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="form-label text-gray-700 fw-bold" for="invoice_number">invoice Number</label>
                                    <input type="text" class="form-control" id="invoice_number" name="invoice_number" placeholder="" value="INVO000{{$invoice_number}}" disabled/>
                                </div>
                                <div class="form-group mt-5">
                                ...
                                <div class="col-mt-5">
                                    <div class="form-group">
                                        <label class="form-label text-gray-700 fw-bold" for="ref_number">Reff Number</label>
                                        <input type="text" class="form-control" id="ref_number" name="ref_number" value="{{$data->ref_number}}"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body transition-fade">
                                        <div class="form-group">
                                            <div data-repeater-list="kt_docs_repeater_basic">
                                                @if ($data->id)
                                                    @foreach ($data->invoiceProduct as $key => $varian)
                                                        <div data-repeater-item>
                                                            ...
                                                            <table>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" name="item" class="form-control mb-2 mb-md-0" value="{{ $varian->item }}"/>
                                                                        </td>
                                                                        <td>
                                                ...
                                                <div data-repeater-item>
                                                        <table>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td>
                                                                        <input type="text" name="item" class="form-control mb-2 mb-md-0"/>
                                                                    </td>
                                                                    <td>
                ...
                <div class="card">
                    <div class="card-footer">
                        ...
                        @if($data->id)
                        <button type="button" onclick="handle_confirm('Are you sure want to delete this invoice ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.finance.invoice.destroy',$data->id)}}');" class="btn btn-sm btn-danger">
                            Delete
                        </button>
                        @endif
                    </div>
