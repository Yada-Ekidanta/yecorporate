    ...
    <tbody class="text-gray-600 fw-semibold">
        ...
        <tr>
            ...
            <td>
                ...
                <a href="javascript:;" onclick="handle_confirm('Are you sure want to delete this credit ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.finance.credit.destroy',$item->id)}}');" class="btn btn-sm btn-hover-scale btn-icon btn-bg-light btn-active-color-danger w-30px h-30px">
                    <span class="svg-icon svg-icon-5 svg-icon-gray-700">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
