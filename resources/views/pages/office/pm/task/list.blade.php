    ...
    <tbody class="text-gray-600 fw-semibold">
        @forelse ($tasks as $key => $item)
            <tr>
                ...
                <td class="text-end">
                    <a href="{{trim(route('office.pm.task.show', $item->id))}}?id={{ $project->id }}" class="btn btn-sm btn-hover-scale btn-icon btn-bg-light btn-active-color-info w-30px h-30px menu-link" data-no-swup>
