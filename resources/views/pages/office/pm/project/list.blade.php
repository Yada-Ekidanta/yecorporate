...
<table class="table align-middle table-row-dashed fs-6 gy-5">
    ...
    <tbody class="text-gray-600 fw-semibold">
        ...
        <tr>
            ...
            <td class="text-end">
                <a href="{{route('office.pm.project.edit',$item->id)}}" class="btn btn-sm btn-hover-scale btn-icon btn-bg-light btn-active-color-warning w-30px h-30px menu-link">
        ...
        <div class="card card-flush h-md-100 bg-secondary">
            <div class="card-header">
                <div class="card-title">
                    <h2><a href="{{route('office.pm.project.show',$item->id)}}" class="link-dark">{{$item->name}}</a></h2>
                </div>
            </div>
            <div class="card-body pt-1">
                <a href="{{route('office.pm.project.show',$item->id)}}" class="image-link">
    ...
    {{-- <div class="col-md-4">
        <div class="card h-md-100">
            <div class="card-body d-flex flex-center">
                <a href="{{route('office.pm.project.create')}}" class="menu-link btn btn-clear d-flex flex-column flex-center">
                    <img src="{{asset('metronic/media/illustrations/sketchy-1/4.png')}}" alt="" class="mw-100 mh-150px mb-7" />
                    <div class="fw-bold fs-3 text-gray-600 text-hover-primary">Add New Project</div>
                </a>
            </div>
        </div>
    </div> --}}
