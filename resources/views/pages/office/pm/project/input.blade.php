                ...
                <form class="form w-100" novalidate="novalidate" id="form_input" data-redirect-url="{{route('office.pm.project.index')}}" action="{{$data->id ? route('office.pm.project.update',$data->id) : route('office.pm.project.store')}}" enctype="multipart/form-data">
                    ...
                    <div class="card-body transition-fade">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6 mb-5">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="end_date" name="end_date" placeholder="Indonesia" value="{{$data->end_date}}"/>
                        ...
                        <div class="form-group row">
                            <div class="col-4 mb-5">
                                <div class="form-floating">
                                    <input type="tel" class="form-control number_only ribuan" id="estimated_hrs" name="estimated_hrs" placeholder="Indonesia" value="{{$data->estimated_hrs}}"/>
                                    <label for="estimated_hrs">Estimated Hours</label>
                                </div>
                            </div>
                            <div class="col-4 mb-5">
                                <div class="form-floating">
                                    <input type="tel" class="form-control number_only ribuan" id="budget" name="budget" placeholder="Indonesia" value="{{$data->budget}}"/>
                                    <label for="budget">Budget</label>
                                </div>
                            </div>
                            <div class="col-4 mb-5">
                                <div class="form-floating">
                                    <input type="text" class="form-control" id="currency" name="currency" placeholder="Indonesia" value="{{$data->currency}}"/>
