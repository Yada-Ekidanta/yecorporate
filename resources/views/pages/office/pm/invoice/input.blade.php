<x-office-layout title="{{$data->id ? 'Update' : 'Create'}} Project">
    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-3 py-lg-6 animation-class delay3">
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="card">
                <form class="form w-100" novalidate="novalidate" id="form_input" data-redirect-url="{{route('office.pm.invoice-pm.index')}}" action="{{$data->id ? route('office.pm.invoice-pm.update',$data->id) : route('office.pm.invoice-pm.store')}}">
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a id="back_form_button" href="{{route('office.pm.invoice-pm.index')}}" class="btn btn-primary btn-sm btn-hover-scale menu-link">
                    ...
                    <div class="card-body transition-fade">
                        <div class="mb-5">
                            <div class="form-floating">
                                <input type="text" class="form-control" id="client" name="client" placeholder="Indonesia" value="{{$data->client}}"/>
                    ...
                    <div class="card-footer">
                        ...
                        @if($data->id)
                        <button type="button" onclick="handle_confirm('Are you sure want to delete this bank ?', 'Yes, i`m sure', 'No, i`m not','DELETE','{{route('office.pm.invoice-pm.destroy',$data->id)}}');" class="btn btn-sm btn-danger">
                            Delete
                        </button>
                        @endif
                    </div>
