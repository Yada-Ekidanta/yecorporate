<x-mobile-layout title="Blog - Kementerian Pertahanan Gelar Indo Defence 2022 Expo & Forum, Pameran Industri Pertahanan Bertaraf Internasional">
            ...
            <div class="splide__track">
                <ul class="splide__list">
                    <li class="splide__slide">
                        <img src="{{asset('img/blog/banner/rdi.jpeg')}}" alt="alt" class="imaged w-100 square">
                    </li>
                    @for ($i = 1; $i < 13; $i++)
                    <li class="splide__slide">
                        <img src="{{asset('img/blog/banner/rdi-'.$i.'.jpeg')}}" alt="alt" class="imaged w-100 square">
                    </li>
                    @endfor
                </ul>
            </div>
    ...
    <div class="blog-post">
        <h1 class="title">Kementerian Pertahanan Gelar Indo Defence 2022 Expo & Forum, Pameran Industri Pertahanan Bertaraf Internasional</h1>
