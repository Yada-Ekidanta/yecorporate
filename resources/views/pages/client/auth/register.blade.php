<x-auth-layout title="Create an Account">
    ...
    <div class="d-flex flex-stack py-2">
        ...
        <div class="m-0">
            ...
            <a href="{{route('client.auth.index')}}" class="link-primary fw-bold fs-5 ye-anima-link" data-kt-translate="sign-up-head-link">Sign In</a>
        </div>
        <!--end::Sign Up link=-->
    </div>
    <!--end::Header-->
    ...
    <div class="py-20">
        <!--begin::Form-->
        <form class="form w-100" novalidate="novalidate" id="form_register" data-redirect-url="{{route('client.auth.index')}}" action="{{route('client.auth.doregister')}}">
            <!--begin::Heading-->
