<x-auth-layout title="Set up new password">
    ...
    <div class="d-flex flex-stack py-2">
        ...
        <div class="m-0">
            ...
            <a href="{{route('client.auth.index')}}" class="link-primary fw-bold fs-5" data-kt-translate="new-password-head-link ye-anima-link">Sign In</a>
        </div>
        <!--end::Sign Up link=-->
    </div>
    <!--end::Header-->
    ...
    <div class="py-20">
        <!--begin::Form-->
        <form class="form w-100" novalidate="novalidate" id="form_reset" data-redirect-url="{{route('client.auth.index')}}" action="{{route('client.auth.doreset')}}">
