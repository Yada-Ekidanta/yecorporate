<x-auth-layout title="Sign In">
    ...
    <div class="d-flex flex-stack py-2">
        ...
        <div class="m-0">
            ...
            <a href="{{route('client.auth.register')}}" class="link-primary fw-bold fs-5 ye-anima-link" data-kt-translate="sign-in-head-link">Sign Up</a>
        </div>
        <!--end::Sign Up link=-->
    </div>
    <!--end::Header-->
    ...
    <div class="py-20">
        <!--begin::Form-->
        <form class="form w-100" novalidate="novalidate" id="form_login" data-redirect-url="dashboard" action="{{route('client.auth.dologin')}}">
            <!--begin::Body-->
            <div class="card-body">
                <!--begin::Heading-->
                ...
                <div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-10">
                    <div></div>
                    <!--begin::Link-->
                    <a href="{{route('client.auth.forgot')}}" class="link-primary ye-anima-link" data-kt-translate="sign-in-forgot-password">Forgot Password ?</a>
                    <!--end::Link-->
                </div>
                <!--end::Wrapper-->
                <!--begin::Actions-->
