    ...
    Route::prefix('office')->name('office.')->group(function(){
        ...
        Route::middleware(['auth:employees'])->group(function(){
            ...
            Route::name('master.')->group(function(){
                Route::resource('allowance', BankController::class);
                Route::resource('asset', BankController::class);
                Route::resource('award-type', BankController::class);
                Route::resource('bank', BankController::class);
                Route::resource('campaign-type', BankController::class);
                Route::resource('case-type', BankController::class);
                Route::resource('client-contract-type', BankController::class);
                Route::resource('client-type', BankController::class);
